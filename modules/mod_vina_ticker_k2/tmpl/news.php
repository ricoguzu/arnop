...
#vina-ticker-k2<?php echo $module->id; ?> a {
	color: <?php echo $itemLinkColor; ?>;
}
#vina-ticker-k2<?php echo $module->id; ?>:before {
...
#vina-ticker-k2<?php echo $module->id; ?> ul li {
    list-style: none outside none;
    padding: <?php echo $itemPadding; ?>;
}
</style>
<div id="vina-ticker-k2<?php echo $module->id; ?>" class="vina-ticker-k2 breaking-news">
	<ul>
		<?php 
...
jQuery(document).ready(function($){
	$('#vina-ticker-k2<?php echo $module->id; ?>').easyTicker({
